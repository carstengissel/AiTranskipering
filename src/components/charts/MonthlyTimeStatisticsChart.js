...
const MonthlyTimeStatisticsChart = memo(({ data }) => {
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-2">
          <ChartTooltip 
            ...
            description="Viser gennemsnitlig tid brugt på forskellige dele af processen pr. måned. 'Tid til godkendelse' er tiden fra AI-referat til godkendelse, mens 'Tid fra transskription til AI-referat' viser behandlingstiden."
          />
        </div>
      </div>
...
export default MonthlyTimeStatisticsChart;
